 ...
 * @flags:  Calculates the number of flags active
 * @width: Width
 ...
 * @types: List a of arguments
 * @buffer: A buffer array that handlea print
 * @flags:  Calculates the number of active flags
 * @width: width.
 * @precision: Specification of precision.
 * @size: Specifier of size
...
/************************* PRINT INT *************************/
/**
 * print_int - An int is printed
 * @types: Lists of arguments
 * @buffer: A buffer array that handles print
 * @flags:  Calculates how many flags are active.
 * @width: obtain width.
